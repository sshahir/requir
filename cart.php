...
<script src="js/cartpagejs.js"></script>
...
<div class="col-sm-6"><div class="alert alert-warning text-center"><strong>Select the items you want to buy.</strong></div>
<div class="img-gallery" id="cart-items">
<?php $Status="cartpage";include("addtocart.php"); ?>
</div>
</div>
<div class="col-sm-6 well well-sm text-center" id="price-info"></div>
</div>
