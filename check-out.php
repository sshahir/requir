...
<script src="js/checkoutpagejs.js"></script>
...
<?php $Status="checkout";include("addtocart.php"); ?>
<div id="all-other-details">
<div class="page-header">
<h4>Order Addressing Details</h4>
</div>
<form role="form" class="form-horizontal" id="order-details">
<div class="form-group">
<label class="control-label col-sm-2" for="name">Full Name : </label>
<div class="col-sm-8">
<input type="text" class="form-control" id="name" autofocus placeholder="Mandatory">
</div>
</div>
<div class="form-group">
<label class="control-label col-sm-2" for="email">Email : </label>
<div class="col-sm-8">
<input type="text" class="form-control" id="email" placeholder="Mandatory">
</div>
</div>
<div class="form-group">
<label class="control-label col-sm-2" for="ph_num">Phone Number : </label>
<div class="col-sm-5">
<input type="tel" class="form-control" id="ph_num" placeholder="Mandatory">
</div>
</div>
<div class="form-group">
<label class="control-label col-sm-2" for="an_ph_num">Another Phone Number : </label>
<div class="col-sm-5">
<input type="tel" class="form-control" id="an_ph_num" placeholder="Optional">
</div>
</div>
<div class="form-group">
<label class="control-label col-sm-2" for="addr">Address : </label>
<div class="col-sm-10">
<input type="text" class="form-control" id="addr" placeholder="Mandatory">
</div>
</div>
<div class="form-group">
<label class="control-label col-sm-2" for="an_addr">Another Address : </label>
<div class="col-sm-10">
<input type="text" class="form-control" id="an_addr" placeholder="Optional">
</div>
</div>
<div class="form-group">
<label class="control-label col-sm-2" for="lndmrk">Landmark : </label>
<div class="col-sm-10">
<input type="text" class="form-control" id="lndmrk" placeholder="Mandatory">
</div>
</div>
<div class="form-group">
<label class="control-label col-sm-2" for="city">City : </label>
<div class="col-sm-4">
<input type="text" class="form-control" id="city" placeholder="Mandatory">
</div>
</div>
<div class="form-group">
<label class="control-label col-sm-2" for="pin">Pin : </label>
<div class="col-sm-3">
<input type="number" class="form-control" id="pin" placeholder="Mandatory">
</div>
</div>
<button type="button" id="proceed-to-payment-area" class="btn btn-success">Save and Proceed To Payment</button>
<div id="proceed-to-payment-area-info" class="alert alert-default"></div>
<div id="payment-details">
<div class="page-header">
<h4>Payment Options</h4>
</div>
<form role="form" id="payment-option">
<div class="radio">
<label><input type="radio" name="optradio" id="cod">Cash On Delivery</label>
</div>
<div class="radio">
<label><input type="radio" name="optradio" id="pp">PayPal</label>
</div>
</form>
<button type="button" class="btn btn-success" id="place-order-button">Place Order</button>
<div id="place-order-button-info" class="alert alert-default"></div>
</div>
